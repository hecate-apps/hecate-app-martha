...
handle_post(Req0, _State) ->
    ...
    case Body of
        <<>> ->
            hecate_plugin_api:json_error(400, <<"request body is required">>, Req1);
        _ ->
...
handle_advance(VentureId, Body, Req1) ->
    ...
    case TargetPhase of
        undefined ->
            hecate_plugin_api:json_error(400, <<"target_phase is required">>, Req1);
        <<>> ->
            hecate_plugin_api:json_error(400, <<"target_phase cannot be empty">>, Req1);
        _ ->
