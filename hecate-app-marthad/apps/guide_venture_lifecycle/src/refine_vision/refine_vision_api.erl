...
do_refine(VentureId, Params, Req) ->
    ...
    Repos = hecate_plugin_api:get_field(repos, Params),
    Skills = hecate_plugin_api:get_field(skills, Params),
    ContextMap = hecate_plugin_api:get_field(context_map, Params),
