%%% @doc pass_boundary_gate_v1 command.
...
-export_type([pass_boundary_gate_v1/0]).
-opaque pass_boundary_gate_v1() :: #pass_boundary_gate_v1{}.
...
-spec validate(pass_boundary_gate_v1()) -> ok | {error, term()}.
validate(#pass_boundary_gate_v1{session_id = S}) when not is_binary(S); byte_size(S) =:= 0 ->
    {error, invalid_session_id};
validate(#pass_boundary_gate_v1{}) ->
    ok.
...
%% Accessors
get_session_id(#pass_boundary_gate_v1{session_id = V}) -> V.
get_passed_by(#pass_boundary_gate_v1{passed_by = V}) -> V.
