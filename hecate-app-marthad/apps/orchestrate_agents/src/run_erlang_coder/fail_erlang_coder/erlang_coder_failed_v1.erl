%%% @doc erlang_coder_failed_v1 event.
%%% Emitted when a erlang_coder agent session fails.
-module(erlang_coder_failed_v1).
...
-export_type([erlang_coder_failed_v1/0]).
-opaque erlang_coder_failed_v1() :: #erlang_coder_failed_v1{}.

-dialyzer({nowarn_function, [new/1, from_map/1]}).

-spec new(map()) -> erlang_coder_failed_v1().
new(#{session_id := SessionId} = Params) ->
    #erlang_coder_failed_v1{
...
%% Accessors
get_session_id(#erlang_coder_failed_v1{session_id = V}) -> V.
get_venture_id(#erlang_coder_failed_v1{venture_id = V}) -> V.
get_tier(#erlang_coder_failed_v1{tier = V}) -> V.
get_model(#erlang_coder_failed_v1{model = V}) -> V.
get_failed_at(#erlang_coder_failed_v1{failed_at = V}) -> V.
get_error_reason(#erlang_coder_failed_v1{error_reason = V}) -> V.
get_tokens_in(#erlang_coder_failed_v1{tokens_in = V}) -> V.
get_tokens_out(#erlang_coder_failed_v1{tokens_out = V}) -> V.
