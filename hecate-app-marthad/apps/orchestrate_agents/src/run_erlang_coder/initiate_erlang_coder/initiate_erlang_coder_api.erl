%%% @doc HTTP handler for initiating a erlang_coder agent session.
-module(initiate_erlang_coder_api).

-export([init/2, routes/0]).

routes() -> [{"/api/agents/erlang_coder/initiate", ?MODULE, []}].
...
do_initiate(Params, Req) ->
    ...
    case VentureId of
        ...
        _ ->
            ...
            case initiate_erlang_coder_v1:new(CmdParams) of
...
dispatch(Cmd, Req) ->
    case maybe_initiate_erlang_coder:dispatch(Cmd) of
