%%% @doc erlang_coder_initiated_v1 event.
%%% Emitted when a erlang_coder agent session is initiated.
-module(erlang_coder_initiated_v1).
...
-record(erlang_coder_initiated_v1, {
    session_id    :: binary(),
    agent_role    :: binary(),
    venture_id    :: binary(),
...
-export_type([erlang_coder_initiated_v1/0]).
-opaque erlang_coder_initiated_v1() :: #erlang_coder_initiated_v1{}.

-dialyzer({nowarn_function, [new/1, from_map/1]}).

-spec new(map()) -> erlang_coder_initiated_v1().
...
%% Accessors
get_session_id(#erlang_coder_initiated_v1{session_id = V}) -> V.
get_venture_id(#erlang_coder_initiated_v1{venture_id = V}) -> V.
get_tier(#erlang_coder_initiated_v1{tier = V}) -> V.
get_model(#erlang_coder_initiated_v1{model = V}) -> V.
get_initiated_at(#erlang_coder_initiated_v1{initiated_at = V}) -> V.
get_initiated_by(#erlang_coder_initiated_v1{initiated_by = V}) -> V.
get_input_context(#erlang_coder_initiated_v1{input_context = V}) -> V.
