%%% @doc architect_completed_v1 event.
%%% Emitted when a architect agent session completes successfully.
-module(architect_completed_v1).
...
-export_type([architect_completed_v1/0]).
-opaque architect_completed_v1() :: #architect_completed_v1{}.

-dialyzer({nowarn_function, [new/1, from_map/1]}).

-spec new(map()) -> architect_completed_v1().
...
%% Accessors
get_session_id(#architect_completed_v1{session_id = V}) -> V.
get_venture_id(#architect_completed_v1{venture_id = V}) -> V.
get_tier(#architect_completed_v1{tier = V}) -> V.
get_model(#architect_completed_v1{model = V}) -> V.
get_completed_at(#architect_completed_v1{completed_at = V}) -> V.
get_notation_output(#architect_completed_v1{notation_output = V}) -> V.
get_parsed_terms(#architect_completed_v1{parsed_terms = V}) -> V.
get_tokens_in(#architect_completed_v1{tokens_in = V}) -> V.
get_tokens_out(#architect_completed_v1{tokens_out = V}) -> V.
