%%% @doc HTTP handler for initiating a delivery_manager agent session.
-module(initiate_delivery_manager_api).

-export([init/2, routes/0]).

routes() -> [{"/api/agents/delivery_manager/initiate", ?MODULE, []}].
...
do_initiate(Params, Req) ->
    ...
    case VentureId of
        ...
        _ ->
            ...
            case initiate_delivery_manager_v1:new(CmdParams) of
...
dispatch(Cmd, Req) ->
    case maybe_initiate_delivery_manager:dispatch(Cmd) of
