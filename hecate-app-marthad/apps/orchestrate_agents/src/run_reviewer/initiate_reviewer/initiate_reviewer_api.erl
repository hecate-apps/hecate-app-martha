%%% @doc HTTP handler for initiating a reviewer agent session.
-module(initiate_reviewer_api).

-export([init/2, routes/0]).

routes() -> [{"/api/agents/reviewer/initiate", ?MODULE, []}].
...
do_initiate(Params, Req) ->
    ...
    case VentureId of
        ...
        _ ->
            ...
            case initiate_reviewer_v1:new(CmdParams) of
...
dispatch(Cmd, Req) ->
    case maybe_initiate_reviewer:dispatch(Cmd) of
