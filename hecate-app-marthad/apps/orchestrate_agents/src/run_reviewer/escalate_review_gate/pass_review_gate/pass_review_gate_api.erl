%%% @doc HTTP handler for passing the review_gate.
-module(pass_review_gate_api).

-export([init/2, routes/0]).

routes() -> [{"/api/agents/reviewer/gates/review-gate/pass", ?MODULE, []}].
...
do_pass(Params, Req) ->
    ...
    case SessionId of
        ...
        _ ->
            ...
            case pass_review_gate_v1:new(CmdParams) of
                {ok, _Cmd} ->
