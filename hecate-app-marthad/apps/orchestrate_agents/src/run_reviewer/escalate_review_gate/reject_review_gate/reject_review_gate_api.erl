%%% @doc HTTP handler for rejecting the review_gate.
-module(reject_review_gate_api).

-export([init/2, routes/0]).

routes() -> [{"/api/agents/reviewer/gates/review-gate/reject", ?MODULE, []}].
...
do_reject(Params, Req) ->
    ...
    case SessionId of
        ...
        _ ->
            ...
            case reject_review_gate_v1:new(CmdParams) of
                {ok, _Cmd} ->
