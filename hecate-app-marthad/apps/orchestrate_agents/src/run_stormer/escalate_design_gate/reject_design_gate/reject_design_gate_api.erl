%%% @doc HTTP handler for rejecting the design_gate.
-module(reject_design_gate_api).

-export([init/2, routes/0]).

routes() -> [{"/api/agents/stormer/gates/design-gate/reject", ?MODULE, []}].
...
do_reject(Params, Req) ->
    ...
    case SessionId of
        ...
        _ ->
            ...
            case reject_design_gate_v1:new(CmdParams) of
                {ok, _Cmd} ->
