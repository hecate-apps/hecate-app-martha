%%% @doc svelte_coder_completed_v1 event.
%%% Emitted when a svelte_coder agent session completes successfully.
-module(svelte_coder_completed_v1).
...
-record(svelte_coder_completed_v1, {
    session_id      :: binary(),
    agent_role      :: binary(),
    venture_id      :: binary(),
...
-export_type([svelte_coder_completed_v1/0]).
-opaque svelte_coder_completed_v1() :: #svelte_coder_completed_v1{}.

-dialyzer({nowarn_function, [new/1, from_map/1]}).

-spec new(map()) -> svelte_coder_completed_v1().
...
%% Accessors
get_session_id(#svelte_coder_completed_v1{session_id = V}) -> V.
get_venture_id(#svelte_coder_completed_v1{venture_id = V}) -> V.
get_tier(#svelte_coder_completed_v1{tier = V}) -> V.
get_model(#svelte_coder_completed_v1{model = V}) -> V.
get_completed_at(#svelte_coder_completed_v1{completed_at = V}) -> V.
get_notation_output(#svelte_coder_completed_v1{notation_output = V}) -> V.
get_parsed_terms(#svelte_coder_completed_v1{parsed_terms = V}) -> V.
get_tokens_in(#svelte_coder_completed_v1{tokens_in = V}) -> V.
get_tokens_out(#svelte_coder_completed_v1{tokens_out = V}) -> V.
