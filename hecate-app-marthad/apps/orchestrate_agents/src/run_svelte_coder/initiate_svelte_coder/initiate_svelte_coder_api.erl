%%% @doc HTTP handler for initiating a svelte_coder agent session.
-module(initiate_svelte_coder_api).

-export([init/2, routes/0]).

routes() -> [{"/api/agents/svelte_coder/initiate", ?MODULE, []}].
...
do_initiate(Params, Req) ->
    ...
    case VentureId of
        ...
        _ ->
            ...
            case initiate_svelte_coder_v1:new(CmdParams) of
...
dispatch(Cmd, Req) ->
    case maybe_initiate_svelte_coder:dispatch(Cmd) of
