%%% @doc HTTP handler for initiating a tester agent session.
-module(initiate_tester_api).

-export([init/2, routes/0]).

routes() -> [{"/api/agents/tester/initiate", ?MODULE, []}].
...
do_initiate(Params, Req) ->
    ...
    case VentureId of
        ...
        _ ->
            ...
            case initiate_tester_v1:new(CmdParams) of
...
dispatch(Cmd, Req) ->
    case maybe_initiate_tester:dispatch(Cmd) of
