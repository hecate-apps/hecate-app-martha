...
-define(SUB_NAME, <<"event_sticky_pulled_v1_to_event_stickies">>).
...
handle_info({events, Events}, State) ->
    lists:foreach(fun(E) ->
        case event_sticky_pulled_v1_to_sqlite_event_stickies:project(app_marthad_projection_event:to_map(E)) of
            ok -> ok;
            {error, Reason} ->
