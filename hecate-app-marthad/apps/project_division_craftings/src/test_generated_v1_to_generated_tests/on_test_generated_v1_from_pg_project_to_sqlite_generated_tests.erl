%%% @doc Projection subscriber: test_generated_v1 -> sqlite generated_tests
...
-define(SUB_NAME, <<"test_generated_v1_to_generated_tests">>).
...
handle_info({events, Events}, State) ->
    lists:foreach(fun(E) ->
        case test_generated_v1_to_sqlite_generated_tests:project(app_marthad_projection_event:to_map(E)) of
            ok -> ok;
            {error, Reason} ->
