...
do_stage(DivisionId, Params, Req) ->
    ReleaseId = hecate_plugin_api:get_field(release_id, Params),
    StageName = hecate_plugin_api:get_field(stage_name, Params),
    StageId = hecate_plugin_api:get_field(stage_id, Params),
