<script lang="ts">
	...
	import { generateModule, generateTest, deliverRelease } from '$lib/craft_division/craft_division.js';
	import TaskCard from '$lib/shared/TaskCard.svelte';

	// --- Tab ---
	let activeTab = $state<'implement' | 'deliver'>('implement');
...
<div class="p-4 space-y-6">
	...
	<div class="flex items-center justify-between">
		<div>
			...
			<p class="text-[11px] text-surface-400 mt-0.5">
				Generate code, run tests, and deliver releases for
	...
	{:else}
		...
		<div class="rounded-lg border border-surface-600 bg-surface-800/50 p-4">
			...
			<p class="text-[10px] text-surface-400">
				Deliver through GitOps: version bump, git tag, CI/CD builds and deploys.
			</p>
		</div>
